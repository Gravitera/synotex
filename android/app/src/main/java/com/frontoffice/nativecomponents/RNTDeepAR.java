...
import com.lynxbus.MainActivity;
import com.lynxbus.R;
...
public class RNTDeepAR extends FrameLayout implements AREventListener, SurfaceHolder.Callback, LifecycleObserver {
    ...
    private com.lynxbus.nativecomponents.CameraGrabber cameraGrabber;
    ...
    private void init() {
        ...
        deepAr.setLicenseKey("8ebf20a5dbec390cc9ac715f107fbf222c2296050f6fd647a2054aecd5b995353a815e806f9ca278");
    ...
    private void setupDeepAR() {
        ...
        cameraGrabber = new com.lynxbus.nativecomponents.CameraGrabber(cameraDevice);
        cameraGrabber.setScreenOrientation(0); // PORTRAIT

        cameraGrabber.setResolutionPreset(CameraResolutionPreset.P1280x720);

        final Activity context = getActivity();
        cameraGrabber.initCamera(new com.lynxbus.nativecomponents.CameraGrabberListener() {
            @Override
