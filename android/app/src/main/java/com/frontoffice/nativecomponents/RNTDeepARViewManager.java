...
public class RNTDeepARViewManager extends SimpleViewManager<com.lynxbus.nativecomponents.RNTDeepAR> {
    ...
    @Override
    protected com.lynxbus.nativecomponents.RNTDeepAR createViewInstance(ThemedReactContext reactContext) {
        return new com.lynxbus.nativecomponents.RNTDeepAR(reactContext);
    }   
    ...
    @Override
    public void receiveCommand(com.lynxbus.nativecomponents.RNTDeepAR deepARView, int commandId, @Nullable ReadableArray args) {
