...
class ArCameraView extends React.Component {
  ...
  async componentDidMount() {
    ...
    delay2xl(value,ths) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            setTimeout(function () {
                ...
                RNFetchBlob.fs.exists(RNFetchBlob.fs.dirs.CacheDir + `/mask/${value}_2xl`).then((exist) => {
                    if(exist){
                        console.log("already downloaded...  skip this period")
                    } else {
                        //if no mask data, start download.....
                        console.log("no dir")
                        console.log("RNFetchBlob.fs.dirs.CacheDir",RNFetchBlob.fs.dirs.CacheDir)
                        console.log("RNFetchBlob.fs.dirs.CacheDir",RNFetchBlob.fs.dirs.CacheDir+'/mask')
                        RNFetchBlob.config({path : RNFetchBlob.fs.dirs.CacheDir + `/mask/${value}_2xl`})
    ...
    delay2xs(value,ths) {
        return new Promise(function (resolve, reject) {
            setTimeout(function () {
                RNFetchBlob.fs.exists(RNFetchBlob.fs.dirs.CacheDir + `/mask/${value}_2xs`).then((exist) => {
                    if(exist){
                        console.log("already downloaded...  skip this period")
                    } else {
                        //if no mask data, start download.....
                        RNFetchBlob.config({path : RNFetchBlob.fs.dirs.CacheDir + `/mask/${value}_2xs`})
    ...
    delay3xs(value,ths) {
        return new Promise(function (resolve, reject) {
            setTimeout(function () {
                RNFetchBlob.fs.exists(RNFetchBlob.fs.dirs.CacheDir + `/mask/${value}_3xs`).then((exist) => {
                    if(exist){
                        console.log("already downloaded...  skip this period")
                    } else {
                        //if no mask data, start download.....
                        RNFetchBlob.config({path : RNFetchBlob.fs.dirs.CacheDir + `/mask/${value}_3xs`})
    ...
    delayl(value,ths) {
        return new Promise(function (resolve, reject) {
            setTimeout(function () {
                RNFetchBlob.fs.exists(RNFetchBlob.fs.dirs.CacheDir + `/mask/${value}_l`).then((exist) => {
                    if(exist){
                        console.log("already downloaded...  skip this period")
                    } else {
                        //if no mask data, start download.....
                        RNFetchBlob.config({path : RNFetchBlob.fs.dirs.CacheDir + `/mask/${value}_l`})
    ...
    delaym(value,ths) {
        return new Promise(function (resolve, reject) {
            setTimeout(function () {
                RNFetchBlob.fs.exists(RNFetchBlob.fs.dirs.CacheDir + `/mask/${value}_m`).then((exist) => {
                    if(exist){
                        console.log("already downloaded...  skip this period")
                    } else {
                        //if no mask data, start download.....
                        RNFetchBlob.config({path : RNFetchBlob.fs.dirs.CacheDir + `/mask/${value}_m`})
    ...
    delays(value,ths) {
        return new Promise(function (resolve, reject) {
            setTimeout(function () {
                RNFetchBlob.fs.exists(RNFetchBlob.fs.dirs.CacheDir + `/mask/${value}_s`).then((exist) => {
                    if(exist){
                        console.log("already downloaded...  skip this period")
                    } else {
                        //if no mask data, start download.....
                        RNFetchBlob.config({path : RNFetchBlob.fs.dirs.CacheDir + `/mask/${value}_s`})
    ...
    delayss(value,ths) {
        return new Promise(function (resolve, reject) {
            setTimeout(function () {
                RNFetchBlob.fs.exists(RNFetchBlob.fs.dirs.CacheDir + `/mask/${value}_ss`).then((exist) => {
                    if(exist){
                        console.log("already downloaded...  skip this period")
                    } else {
                        //if no mask data, start download.....
                        RNFetchBlob.config({path : RNFetchBlob.fs.dirs.CacheDir + `/mask/${value}_ss`})
    ...
    delayxl(value,ths) {
        return new Promise(function (resolve, reject) {
            setTimeout(function () {
                RNFetchBlob.fs.exists(RNFetchBlob.fs.dirs.CacheDir + `/mask/${value}_xl`).then((exist) => {
                    if(exist){
                        console.log("already downloaded...  skip this period")
                    } else {
                        //if no mask data, start download.....
                        RNFetchBlob.config({path : RNFetchBlob.fs.dirs.CacheDir + `/mask/${value}_xl`})
    ...
    delayxs(value,ths) {
        return new Promise(function (resolve, reject) {
            setTimeout(function () {
                RNFetchBlob.fs.exists(RNFetchBlob.fs.dirs.CacheDir + `/mask/${value}_xs`).then((exist) => {
                    console.log("is exist? ::",exist)
                    if(exist){
                        console.log("already downloaded...  skip this period")
                        this.setState({checkDownload: false})
                        console.log(RNFetchBlob.fs.dirs.CacheDir + `/mask/${value}_xs`)
                    } else {
                        //if no mask data, start download.....
                        console.log("nodata downloaded... start download")
                        RNFetchBlob.config({path : RNFetchBlob.fs.dirs.CacheDir + `/mask/${value}_xs`})
